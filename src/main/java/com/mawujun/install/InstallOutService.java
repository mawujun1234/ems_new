...
//			inStoreList.setEcode(equipment.getEcode());
			...
			//记录设备入库的生命周期
			equipmentCycleService.logEquipmentCycle(inStoreList.getEcode(), OperateType.install_out, installOut_id,TargetType.workunit,outStore.getWorkUnit_id(),inStoreList.getMemo());
		}
...
//	}
	...
	public Pager<InstallOut> queryMain(Pager<InstallOut> page){
	...
	public Pager<InstallOutList> queryDifference(Pager<InstallOutList> page){
