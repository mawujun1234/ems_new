...
public class BorrowController {
	...
	@ResponseBody
	public Pager<Borrow> queryMain(Integer start,Integer limit,String operateDate_start,String operateDate_end,String store_id,String workUnit_id,String project_id,BorrowStatus status) { 
		Pager<Borrow> page=new Pager<Borrow>();//Page.getInstance(start, limit);
		page.setStart(start);
		page.setLimit(limit);
