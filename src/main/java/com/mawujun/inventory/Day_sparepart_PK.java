...
public class Day_sparepart_PK  implements Serializable{
	...
	public Day_sparepart_PK() {  
        super();
    } 
	public Day_sparepart_PK(Integer day, String prod_id, String store_id) {
		super();
		this.daykey = day;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Day_sparepart_PK other = (Day_sparepart_PK) obj;
		if (daykey == null) {
