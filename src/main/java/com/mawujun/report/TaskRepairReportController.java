...
public class TaskRepairReportController {
	...
	@ResponseBody
	public Pager<TaskRepairReport> queryRepairReport(Integer start,Integer limit,String date_start,String date_end,String pole_code,String hitchType_id) {
		Pager<TaskRepairReport> page=new Pager<TaskRepairReport>();//Page.getInstance(start, limit)
		page.setStart(start);
		page.setLimit(limit);
		page.addParam("date_start", date_start);
		page.addParam("date_end", date_end);
		page.addParam("pole_code", pole_code);
		page.addParam("hitchType_id", hitchType_id);
