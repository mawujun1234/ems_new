...
public class TaskReportController {
	...
	@ResponseBody
	public Pager<TaskVO> queryUnrepairPoleReport(Integer start,Integer limit,String workunit_id,String customer_id,String date_start,String date_end) {
		Pager<TaskVO> page=new Pager<TaskVO>();//Page.getInstance(start,limit);
		page.setStart(start);
		page.setLimit(limit);
