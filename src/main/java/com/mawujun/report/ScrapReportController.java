...
public class ScrapReportController {
	...
	@ResponseBody
	public Pager<RepairVO> queryScrapReport(Integer start,Integer limit,String date_start,String date_end){
		Pager<RepairVO> page=new Pager<RepairVO>();//Page.getInstance(start,limit);
		page.setStart(start);
		page.setLimit(limit);
		...
		Pager<RepairVO> result=repairReportRepository.queryScrapReport(page);
		return result;
	}
