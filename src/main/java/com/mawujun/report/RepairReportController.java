...
public class RepairReportController {
	...
	@ResponseBody
	public Pager<RepairReport> queryRepairReport(Integer start,Integer limit,String date_start,String date_end){
		Pager<RepairReport> page=new Pager<RepairReport>();//Page.getInstance(start,limit);
		page.setStart(start);
		page.setLimit(limit);
		...
		Pager<RepairReport> result=repairReportRepository.queryRepairReport(page);
		return result;
	}
