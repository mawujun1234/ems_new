...
//	}
	...
	@ResponseBody
	public Pager<RepairVO> storeMgrQuery(Integer start,Integer limit, String str_out_id,String rpa_id,String str_out_date_start,String str_out_date_end
			,String ecode,RepairStatus status,Boolean only_have_scap){
		Pager<RepairVO> page=new Pager<RepairVO>();//Page.getInstance(start,limit);//.addParam(M.Repair.sampleName, "%"+sampleName+"%");
		page.setStart(start);
		page.setLimit(limit);
	...
	@ResponseBody
	public Pager<RepairVO> repairInQuery(Integer start,Integer limit, String str_out_id,String rpa_id,String str_out_date_start,String str_out_date_end
	...
	@ResponseBody
	public Pager<RepairVO> repairMgrQuery(Integer start,Integer limit, String str_out_id,String rpa_id,String rpa_in_date_start,String rpa_in_date_end
			,String ecode,RepairStatus status,Boolean only_have_scap){
		Pager<RepairVO> page=new Pager<RepairVO>();//Page.getInstance(start,limit);//.addParam(M.Repair.sampleName, "%"+sampleName+"%");
		page.setStart(start);
		page.setLimit(limit);
