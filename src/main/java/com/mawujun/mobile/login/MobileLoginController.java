...
//             //return ShiroUtils.getAuthenticationInfo();
			...
			ResultModel resultModel=ResultModel.getInstance();
			resultModel.addAttribute("session_id", request.getSession().getId());
			resultModel.setRoot(ShiroUtils.getAuthenticationInfo());
            return resultModel;
//        }  
