...
public class TaskController {
	...
	@ResponseBody
	public Pager<Pole> queryPoles(Integer start,Integer limit,String customer_id,String filter_other,String area_id,String workunit_id,String pole_name) {
		Pager<Pole> page=new Pager<Pole>();//Page.getInstance(start,limit);
...
//		}
	...
	@ResponseBody
	public Pager<Task> query(Integer start,Integer limit,String customer_id,TaskStatus status,String type,String workunit_id,String pole_id,String pole_name,Boolean isOvertime) {
		Pager<Task> page=new Pager<Task>();//Page.getInstance(start,limit);
		page.setStart(start);
		page.setLimit(limit);
	...
	@ResponseBody
	public Pager<Task> querySubmited(Integer start,Integer limit,String customer_id,String type,String hitchType_id,String workunit_id,String pole_name) {
		Pager<Task> page=new Pager<Task>();//Page.getInstance(start,limit);
		page.setStart(start);
		page.setLimit(limit);
		page.addParam(M.Task.customer_id, customer_id);
...
//	}
	...
	@ResponseBody
	public Pager<Task> mobile_query(Integer start,Integer limit,String status,String type,String orderBy){
		Pager<Task> page=new Pager<Task>();//Page.getInstance(start,limit);//.addParam(M.Task.sampleName, "%"+sampleName+"%");
		page.setStart(start);
		page.setLimit(limit);
		page.addParam(M.Task.status, status);
		page.addParam(M.Task.type, type);
		...
		Pager<Task> aa =taskService.mobile_queryPage(page);
		return aa;
	}
	
	@RequestMapping("/task/mobile/search.do")
	@ResponseBody
	public Pager<Task> mobile_search(String status,String searchStr,Integer start,Integer limit){
		Pager<Task> page=new Pager<Task>();//Page.getInstance(start,limit);
		page.setStart(start);
		page.setLimit(limit);
		page.addParam(M.Task.status, status);
		...
		page.addParam(M.Task.workunit_id, ShiroUtils.getAuthenticationInfo().getId());
		Pager<Task> aa =taskService.mobile_search(page);
		return aa;
