...
Ext.onReady(function(){
	...
	var grid=Ext.create('Ext.grid.Panel',{
		...
		columns:[
			{xtype: 'rownumberer'},
			{dataIndex:'id',text:'维修单号',width:150},
			{dataIndex:'str_out_name',text:'出库仓库'},
			{dataIndex:'rpa_in_date',text:'坏件领料时间',width:150},
			...
			{dataIndex:'scrap_reason',text:'报废原因',flex:1,minWidth:150},
			{dataIndex:'scrap_residual',text:'坏件残值'},
			{dataIndex:'scrap_operateDate',text:'报废确认时间',width:150},
