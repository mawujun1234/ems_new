...
//						if (newValue) {
//							subtype_combox.getStore().getProxy().extraParams = {
//								equipmentType_id : newValue
//							};
...
//					width : 60,
//					items : [{
//						icon : '../images/delete.gif', // Use a URL in the icon
//						// config
//						tooltip : '删除',
//						handler : function(grid, rowIndex, colIndex) {
//							var rec = equipStore.getAt(rowIndex);
//							Ext.MessageBox.confirm('确认', '您确认要删除该记录吗?',
//									function(btn) {
//										if (btn == 'yes') {
...
//						}, {
//							header : '月',
//							itemId : 'depreci_month',
//							dataIndex : 'depreci_month',
//							xtype : 'numbercolumn',
//							format : '0',
//							width : 30,
//							hidden : true
...
//				// var type_model=
//				// type_combox.getStore().createModel({id:record.get("type_id"),text:record.get("type_name")});
//				// type_combox.setValue(type_model);
//				// alert(type_combox.getValue());
//
//				// var subtype_model=
//				// subtype_combox.getStore().createModel({id:record.get("subtype_id"),text:record.get("subtype_name")});
...
//
//				// var supplier_model=
//				// supplier_combox.getStore().createModel({id:record.get("supplier_id"),name:record.get("supplier_name")});
...
//
//				depreci_year.setValue(record.get("depreci_year") ? record
//						.get("depreci_year") : 0);
//				depreci_month.setValue(record.get("depreci_month") ? record
//						.get("depreci_month") : 0);
//				depreci_day.setValue(record.get("depreci_day") ? record
//						.get("depreci_day") : 0);
//
//				type_combox.disable();
...
//				xtype : 'fieldcontainer',
//				layout : 'hbox',
//				items : [project_combox, supplier_combox]
//			}, {
//				xtype : 'fieldcontainer',
//				layout : 'hbox',
//				items : [type_combox, subtype_combox, prod_name,
//						queryProd_button, brand_name, style]
//			}, {
//				xtype : 'fieldcontainer',
//				layout : 'hbox',
//				items : [prod_spec, prod_unit]
//			}, {
//				itemId : 'depreci_container',
//				hidden : true,
//				xtype : 'fieldcontainer',
//				layout : 'hbox',
//				items : [{
...
//				items : [
//
//						quality_month_field, orderNum_field, unitprice_field,
//						totalprice_display]
//			}
//
//			]
