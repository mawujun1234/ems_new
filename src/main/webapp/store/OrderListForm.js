Ext.define('Ems.store.OrderListForm', {
	...
	requires : ['Ems.store.OrderList', 'Ems.baseinfo.EquipmentProdQueryGrid'],
	fieldDefaults : {
		msgTarget : 'side',
		labelWidth : 75,
		labelAlign : 'right',
	...
	initComponent : function() {
								...
								'Ems.baseinfo.EquipmentProdQueryGrid', {
									listeners : {
										itemdblclick : function(view, record,
											...
											prod_name.setValue(record
													.get("name"));
											prod_spec.setValue(record
													.get("spec"));
											prod_unit.setValue(record
													.get("unit"));
		...
		me.items = [{
					...
					layout : 'hbox',
					items : [id_field, order_id, brand_id, prod_id]
				}, {
					xtype : 'fieldcontainer',
					layout : 'hbox',
					...
					xtype : 'fieldcontainer',
					layout : 'hbox',
					items : [quality_month_field, orderNum_field,
							unitprice_field, totalprice_display,
							totalNum_display]
				}
		...
		var saveButton = Ext.create('Ext.button.Button', {
					...
					handler : function(btn) {
						...
						if (me.order_orderType == "old_equipment"
								&& !(depreci_year.getValue()
										|| depreci_month.getValue() || depreci_month
										.getValue())) {
							alert("请填写还可使用年数!");
							return;
						}
