Ext.define('Ems.check.CheckGrid',{
	...
	initComponent: function () {
      ...
      me.columns=[
      	{xtype: 'rownumberer'},
		{dataIndex:'id',header:'编号',width:140
        },
        {dataIndex:'task_id',header:'任务编号',width:140
        },
        {dataIndex:'pole_name',header:'点位',width:150
        },
		{dataIndex:'status_name',header:'状态'
        },
//        {dataIndex:'creater',header:'创建人'
//        },
		{dataIndex:'createDate',header:'创建时间',width:150
		},
//		{dataIndex:'completer',header:'完成人'
//        },
		{dataIndex:'completeDate',header:'完成时间',width:150
		}
	  ...
	  me.dockedItems.push({
		  	...
		  	items:[{
				...
				store:{
					fields:['key','value'],
					data:[{key:'',value:'所有'},{key:'handling',value:'处理中'},{key:'complete',value:'完成'}]
				},
				listeners:{
